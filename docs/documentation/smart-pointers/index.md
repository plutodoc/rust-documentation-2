...
_Smart pointers_, on the other hand, are data structures that not only act like
...
One example that we’ll explore in this chapter is the _reference counting_
