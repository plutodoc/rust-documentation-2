...
- At any given time, you can have _either_ (but not both of) one mutable
...
A _test double_ is the general programming concept for a type used in place of
another type during testing. _Mock objects_ are specific types of test doubles
