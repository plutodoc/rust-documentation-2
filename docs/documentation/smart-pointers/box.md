...
We’ll demonstrate the first situation in the [“Enabling Recursive Types withBoxes”](#enabling-recursive-types-with-boxes)<!-- ignore --> section. In the
...
whose size can’t be known at compile time is a _recursive type_, where a value
...
Let’s explore the _cons list_, which is a data type common in functional
...
programming jargon: “to cons _x_ onto _y_” informally means to construct a new
container instance by putting the element _x_ at the start of this new
container, followed by the container _y_.
...
complex recursive data types _are_ useful in various situations, but by
...
![An infinite Cons list](/images/trpl15-01.png)
...
![A finite Cons list](/images/trpl15-02.png)
