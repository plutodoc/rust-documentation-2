...
The most widely used form of macros in Rust is _declarative macros_. These are
...
programmers will _use_ macros more than _write_ macros, we won’t discuss
...
The second form of macros is _procedural macros_, which act more like functions
